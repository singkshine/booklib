...
#ifndef BLOCK
#define BLOCK 15//弃案 原本准备写存储在file中时的间距，暂时未想到解决方案
#endif
...
extern BOOK *head;
extern BOOK *tail;
extern BOOK *book;//这个book貌似有漏洞，可能存储多次定义的情况，后续做更改
#endif

#ifndef FILE_STO_H
#define FILE_STO_H
int file_book_sto();//将链表中的书全部存入txt文件
...
int sum_add_book(void *books);//书数量+1
int sum_reduce_book(void *books);//书数量-1
